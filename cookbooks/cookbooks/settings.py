"""
Django settings for cookbooks project.
...
SECRET_KEY = 'django-insecure-+jwe5$7_344s@gxeu%_-5mv&bw&k$tj$039jr#5i+tg7wk&*tl'
...
WSGI_APPLICATION = 'cookbooks.wsgi.application'
...
# for connecting to postgres db in AWS RDS
# DATABASES = {
#     'aws': {
